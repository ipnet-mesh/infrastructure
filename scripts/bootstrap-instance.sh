...
echo "  cd ${INSTANCE_DIR} && docker compose -f docker-compose.yml -f docker-compose.prod.yml -f docker-compose.traefik.yml --profile core --profile metrics up -d"
echo ""
echo "To start (without monitoring):"
